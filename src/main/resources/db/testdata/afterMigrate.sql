...
(6, 'Débora Mendonça', 'jpo.teste32+debora@gmail.com', '$2y$12$NSsM4gEOR7MKogflKR7GMeYugkttjNhAJMvFdHrBLaLp2HzlggP5W', utc_timestamp),
(7, 'Carlos Lima', 'jpo.teste32+carlos@gmail.com', '$2y$12$NSsM4gEOR7MKogflKR7GMeYugkttjNhAJMvFdHrBLaLp2HzlggP5W', utc_timestamp);
...
values (
  ...
  'READ,WRITE', 'password,authorization_code', 'http://localhost:9000,http://localhost:9000/swagger-ui/oauth2-redirect.html', null,
...
values (
  ...
  'READ,WRITE', 'authorization_code', 'http://api.algafood.local:8000/', null,
  null, null, null
);
